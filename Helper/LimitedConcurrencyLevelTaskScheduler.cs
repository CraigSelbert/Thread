...
namespace Threading.Helper
{
    ...
    public class LimitedConcurrencyLevelTaskScheduler : TaskScheduler
    {
        ...
        public LimitedConcurrencyLevelTaskScheduler(int maxDegreeOfParallelism, int delayBetweenCalls = 0)
        {
            if (maxDegreeOfParallelism < 1) throw new ArgumentOutOfRangeException(nameof(maxDegreeOfParallelism));
            _maxDegreeOfParallelism = maxDegreeOfParallelism;

            _delayBetweenCalls = delayBetweenCalls;
        }
            ...
            ThreadPool.UnsafeQueueUserWorkItem(_ =>
            {
                ...
                try
                {
                    ...
                    while (true)
                    {
                        ...
                        if (_delayBetweenCalls > 0)
                            Thread.Sleep(_delayBetweenCalls);
                    }
                }
